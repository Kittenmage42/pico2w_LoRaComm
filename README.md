...
Dieses Projekt verwendet ein ssd1306 OLED dieplay, einen Knopf und einen Rotary Encoder (sowie pico, breadboard und kabel). Weitere Infos in main.cpp. Dieses Projekt verwendet das Raspberry Pi Pico C/C++ SDK, sowie die Pico ssd1306 library von David Schramm (https://github.com/daschr/pico-ssd1306). 
